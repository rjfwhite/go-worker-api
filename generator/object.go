...
func GenerateObjectType(t ObjectDefinition) string {
	output := ""
...
func GenerateReadObjectType(t ObjectDefinition) string {
	output := ""
...
func GenerateWriteObjectType(t ObjectDefinition) string {
	output := ""
